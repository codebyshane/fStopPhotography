...
function renderInquiryForm(site) {
  ...
  return [
    ...
    '<label for="inquiry-visitor"><span>Name</span></label>',
    '<input id="inquiry-visitor" type="text" name="visitor" maxlength="80" autocomplete="name" required />',
    '<label for="inquiry-reply">Your email</label>',
    '<input id="inquiry-reply" type="email" name="replyTo" maxlength="120" autocomplete="email" />',
    '<label for="inquiry-topic">About</label>',
    ...
    '</select>',
    '<label for="inquiry-message">Note</label>',
    '<textarea id="inquiry-message" name="message" rows="6" maxlength="2000" required placeholder="What are you hoping to make, license, or ask about?"></textarea>',
