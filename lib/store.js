...
function updateSite(fields) {
  const data = read();
  if (typeof fields.photographer === 'string') {
    data.site.photographer = fields.photographer.trim();
  }
  if (typeof fields.about === 'string') {
    data.site.about = fields.about.trim();
  }
  if (typeof fields.inquiries === 'string') {
    data.site.inquiries = fields.inquiries.trim();
  }
